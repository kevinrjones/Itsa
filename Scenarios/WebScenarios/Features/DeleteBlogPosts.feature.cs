...
#line hidden
        ...
        public virtual void FeatureSetup()
        {
            ...
            TechTalk.SpecFlow.FeatureInfo featureInfo = new TechTalk.SpecFlow.FeatureInfo(new System.Globalization.CultureInfo("en-US"), "DeleteBlogPosts", "In order to delete posts from the blog\r\nAs a blog administrator\r\nI want to be abl" +
                    "e to delete blog posts", ProgrammingLanguage.CSharp, ((string[])(null)));
        ...
        [NUnit.Framework.DescriptionAttribute("Delete a blog post should be available as an administrator")]
        [NUnit.Framework.CategoryAttribute("addpost")]
        [NUnit.Framework.CategoryAttribute("deletepost")]
        public virtual void DeleteABlogPostShouldBeAvailableAsAnAdministrator()
        {
            TechTalk.SpecFlow.ScenarioInfo scenarioInfo = new TechTalk.SpecFlow.ScenarioInfo("Delete a blog post should be available as an administrator", new string[] {
                        "addpost",
                        "deletepost"});
#line 8
...
#line 10
 testRunner.Then("the delete blog post element show be shown", ((string)(null)), ((TechTalk.SpecFlow.Table)(null)), "Then ");
#line hidden
