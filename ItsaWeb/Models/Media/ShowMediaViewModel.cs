...
namespace ItsaWeb.Models.Media
{
    public class ShowMediaViewModel
    {
        ...
        {
            _sizeLookup.Add((int) Entities.Media.ValidSizes.Fullsize, "img-fullsize");
            _sizeLookup.Add((int) Entities.Media.ValidSizes.Thumbnail, "img-thumbnail");
            _sizeLookup.Add((int) Entities.Media.ValidSizes.Medium, "img-medium");
            _sizeLookup.Add((int) Entities.Media.ValidSizes.Large, "img-large");

            _alignLookup.Add((int) Entities.Media.ValidAllignments.None, "");
            _alignLookup.Add((int) Entities.Media.ValidAllignments.Right, "img-align-right");
            _alignLookup.Add((int) Entities.Media.ValidAllignments.Left, "img-align-left");
        }

        public ShowMediaViewModel(Entities.Media media)
            : this()
        {
            Id = media.Id;
